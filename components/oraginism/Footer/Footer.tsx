...
export const Footer = () => {
  return (
    <footer
        className="bg-orange-500 pt-20 px-10 lg:pt-[120px] relative z-10 wow fadeInUp"        
      >
            ...
            <div className="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
              <div className="w-full mb-10">
                ...
                <p className="text-base text-[#f3f4fe] mb-7">
                  Chuyên cung cấp hệ thống giám sát an ninh
                </p>
              </div>
            </div>
        ...
        <div className="border-t border-opacity-40 py-8 mt-12 lg:mt-[60px]">
          <div className="container">
            <div className="flex flex-wrap justify-center -mx-4">
              <p className="text-base text-center text-[#f3f4fe]">
                Copyright by Camninh 2022
              </p>
            </div>
          </div>
        </div>
